...
#ifndef Superteam_HPP
#define Superteam_HPP
...
// World1
class Game0_Superteam : public UserGame0
{
public:
...
// World2
class Game1_Superteam : public UserGame1
...
private:
    ...
    const static int kBorderSameObjNum = 2;
    const static int kFindObjDuration = Game0_Superteam::kFindObjDuration;
